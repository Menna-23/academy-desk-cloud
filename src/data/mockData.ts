...
export const users: User[] = [
  // Al-Nour
  { id: 'u1', name: 'Ahmed Fouad', username: 'admin@alnour', password: 'admin123', role: 'admin', centerId: 'alnour', avatar: 'AF', status: 'Active' },
  { id: 'u2', name: 'Nadia Mostafa', username: 'nadia.moderator', password: 'mod123', role: 'moderator', centerId: 'alnour', avatar: 'NM', studentsManaged: 87, lastActive: 'Today', status: 'Active' },
  { id: 'u3', name: 'Hany Fawzy', username: 'hany.mod', password: 'mod123', role: 'moderator', centerId: 'alnour', avatar: 'HF', studentsManaged: 61, lastActive: 'Yesterday', status: 'Active' },
  { id: 'u4', name: 'Rania Adel', username: 'rania.mod', password: 'mod123', role: 'moderator', centerId: 'alnour', avatar: 'RA', studentsManaged: 54, lastActive: '3 days ago', status: 'Active' },
  { id: 'u5', name: 'Sherif Nabil', username: 'sherif.mod', password: 'mod123', role: 'moderator', centerId: 'alnour', avatar: 'SN', studentsManaged: 46, lastActive: '1 week ago', status: 'Inactive' },
  { id: 'u6', name: 'Dr. Ahmed Hassan', username: 'dr.ahmed', password: 'teach123', role: 'teacher', centerId: 'alnour', avatar: 'AH', subject: 'Mathematics', studentCount: 18, courseCount: 3, status: 'Active', email: 'ahmed.hassan@alnour.edu' },
  { id: 'u7', name: 'Ms. Sara Khaled', username: 'ms.sara', password: 'teach123', role: 'teacher', centerId: 'alnour', avatar: 'SK', subject: 'Physics', studentCount: 12, courseCount: 2, status: 'Active', email: 'sara.khaled@alnour.edu' },
  { id: 'u8', name: 'Mr. Omar Youssef', username: 'mr.omar', password: 'teach123', role: 'teacher', centerId: 'alnour', avatar: 'OY', subject: 'Chemistry', studentCount: 9, courseCount: 2, status: 'Active', email: 'omar.youssef@alnour.edu' },
  { id: 'u9', name: 'Ms. Layla Mahmoud', username: 'ms.layla', password: 'teach123', role: 'teacher', centerId: 'alnour', avatar: 'LM', subject: 'English', studentCount: 7, courseCount: 1, status: 'Active', email: 'layla.mahmoud@alnour.edu' },
  { id: 'u10', name: 'Dr. Karim Saleh', username: 'dr.karim', password: 'teach123', role: 'teacher', centerId: 'alnour', avatar: 'KS', subject: 'Biology', studentCount: 6, courseCount: 1, status: 'Inactive', email: 'karim.saleh@alnour.edu' },
  // Bright Minds
  { id: 'u11', name: 'Mariam Tawfik', username: 'admin@brightminds', password: 'admin123', role: 'admin', centerId: 'brightminds', avatar: 'MT', status: 'Active' },
  { id: 'u12', name: 'Sara Nour', username: 'sara.mod', password: 'mod123', role: 'moderator', centerId: 'brightminds', avatar: 'SN', studentsManaged: 72, lastActive: 'Today', status: 'Active' },
  { id: 'u13', name: 'Tarek Adel', username: 'tarek.mod', password: 'mod123', role: 'moderator', centerId: 'brightminds', avatar: 'TA', studentsManaged: 62, lastActive: 'Yesterday', status: 'Active' },
  { id: 'u14', name: 'Ms. Layla Farouk', username: 'ms.layla', password: 'teach123', role: 'teacher', centerId: 'brightminds', avatar: 'LF', subject: 'Mathematics', studentCount: 45, courseCount: 3, status: 'Active' },
  { id: 'u15', name: 'Mr. Bassem Samir', username: 'mr.bassem', password: 'teach123', role: 'teacher', centerId: 'brightminds', avatar: 'BS', subject: 'Science', studentCount: 38, courseCount: 2, status: 'Active' },
  // Cairo Univ
  { id: 'u16', name: 'Prof. Khaled Mansour', username: 'admin@cairouniv', password: 'admin123', role: 'admin', centerId: 'cairouniv', avatar: 'KM', status: 'Active' },
  { id: 'u17', name: 'Dr. Rania Mostafa', username: 'dr.rania', password: 'teach123', role: 'teacher', centerId: 'cairouniv', avatar: 'RM', subject: 'Engineering', studentCount: 156, courseCount: 5, status: 'Active' },
  { id: 'u18', name: 'Dr. Wael Saeed', username: 'dr.wael', password: 'teach123', role: 'teacher', centerId: 'cairouniv', avatar: 'WS', subject: 'IT', studentCount: 134, courseCount: 4, status: 'Active' },
  // Future Stars
  { id: 'u19', name: 'Heba Gamal', username: 'admin@futurestars', password: 'admin123', role: 'admin', centerId: 'futurestars', avatar: 'HG', status: 'Active' },
  { id: 'u20', name: 'Dina Ramzy', username: 'dina.mod', password: 'mod123', role: 'moderator', centerId: 'futurestars', avatar: 'DR', studentsManaged: 67, lastActive: 'Today', status: 'Active' },
  { id: 'u21', name: 'Ms. Aya Sherif', username: 'ms.aya', password: 'teach123', role: 'teacher', centerId: 'futurestars', avatar: 'AS', subject: 'Early Learning', studentCount: 67, courseCount: 2, status: 'Active' },
];

// Students (Al-Nour primarily)
export const students: Student[] = [
  { id: 's1', name: 'Ali Mohamed', username: 'ali.mohamed.2026', email: 'ali@student.edu', phone: '+20 10 1111 1111', centerId: 'alnour', joinedDate: 'Jan 15, 2026', status: 'Active', enrolledTeachers: ['u6', 'u7'], subjects: ['Mathematics', 'Physics'], avatar: 'AM' },
  { id: 's2', name: 'Fatma Ibrahim', username: 'fatma.ibrahim.2026', email: 'fatma@student.edu', phone: '+20 10 2222 2222', centerId: 'alnour', joinedDate: 'Jan 18, 2026', status: 'Active', enrolledTeachers: ['u6'], subjects: ['Mathematics'], avatar: 'FI' },
  { id: 's3', name: 'Youssef Samir', username: 'youssef.samir.2026', email: 'youssef@student.edu', phone: '+20 10 3333 3333', centerId: 'alnour', joinedDate: 'Jan 20, 2026', status: 'Active', enrolledTeachers: ['u7', 'u8'], subjects: ['Physics', 'Chemistry'], avatar: 'YS' },
  { id: 's4', name: 'Nour Ahmed', username: 'nour.ahmed.2026', email: 'nour@student.edu', phone: '+20 10 4444 4444', centerId: 'alnour', joinedDate: 'Feb 1, 2026', status: 'Active', enrolledTeachers: ['u6'], subjects: ['Mathematics'], avatar: 'NA' },
  { id: 's5', name: 'Mona Hassan', username: 'mona.hassan.2026', email: 'mona@student.edu', phone: '+20 10 5555 5555', centerId: 'alnour', joinedDate: 'Feb 3, 2026', status: 'Active', enrolledTeachers: ['u8'], subjects: ['Chemistry'], avatar: 'MH' },
  { id: 's6', name: 'Khaled Omar', username: 'khaled.omar.2026', email: 'khaled@student.edu', phone: '+20 10 6666 6666', centerId: 'alnour', joinedDate: 'Feb 5, 2026', status: 'Active', enrolledTeachers: ['u6', 'u7', 'u8'], subjects: ['Mathematics', 'Physics', 'Chemistry'], avatar: 'KO' },
  { id: 's7', name: 'Dina Saad', username: 'dina.saad.2026', email: 'dina@student.edu', phone: '+20 10 7777 7777', centerId: 'alnour', joinedDate: 'Feb 8, 2026', status: 'Active', enrolledTeachers: ['u7'], subjects: ['Physics'], avatar: 'DS' },
  { id: 's8', name: 'Tarek Hosny', username: 'tarek.hosny.2026', email: 'tarek@student.edu', phone: '+20 10 8888 8888', centerId: 'alnour', joinedDate: 'Feb 10, 2026', status: 'Inactive', enrolledTeachers: ['u6'], subjects: ['Mathematics'], avatar: 'TH' },
  { id: 's9', name: 'Salma Adel', username: 'salma.adel.2026', email: 'salma@student.edu', phone: '+20 10 9999 0000', centerId: 'alnour', joinedDate: 'Feb 12, 2026', status: 'Active', enrolledTeachers: ['u9'], subjects: ['English'], avatar: 'SA' },
  { id: 's10', name: 'Hassan Magdy', username: 'hassan.magdy.2026', email: 'hassan@student.edu', phone: '+20 10 0000 1111', centerId: 'alnour', joinedDate: 'Feb 15, 2026', status: 'Active', enrolledTeachers: ['u6', 'u10'], subjects: ['Mathematics', 'Biology'], avatar: 'HM' },
];
...
export const subjectPassRates = [
  { subject: 'Mathematics', enrolled: 68, passed: 52, rate: 76 },
  { subject: 'Physics', enrolled: 48, passed: 38, rate: 79 },
  { subject: 'Chemistry', enrolled: 43, passed: 35, rate: 81 },
  { subject: 'English', enrolled: 37, passed: 31, rate: 84 },
  { subject: 'Biology', enrolled: 21, passed: 14, rate: 67 },
];

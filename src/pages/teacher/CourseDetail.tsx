...
export default function CourseDetail() {
  ...
  const handleAIGenerated = (questions: TestQuestion[]) => {
    setTestQuestions(questions);
    setAiQuestionsGenerated(true);
    toast({ title: 'Questions Generated!', description: `${questions.length} questions generated by AI. Review and edit below.` });
  };
